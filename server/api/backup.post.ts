...
<head>
  <title>One Tab Group Email Template</title>
  <!--[if !mso]>-->
...
<body>
  <center data-parsed="onetabgroup">
                    ...
                    <table>
                      ...
                      <tr>
                        <th>
                          <table align="left">
                            <tr>
                              <img src="cid:logo" align="left" class="float-left" style="height: 48px; width: 296px;">
                            </tr>
                            <tr>
                              <center data-parsed="">
                      ...
                      <tr>
                        <th>
                          <center data-parsed="">
                            <img src="cid:preview" align="center" class="float-center">
                          </center>
                        </th>
                        <th class="expander"></th>
                      </tr>
...
const sendBackupEmail = async (username: string, to: string, blob?: Blob) => {
  ...
  const template = ejs.compile(emailStr, 'utf8')
